...
const WorkshopContent = [
  {
    ...
    Speaker: "Annapurna S M and Team",
    SpeakerImg: DSP,
    SpeakerDesc:
      " Signal processing engineer with a demonstrated history of working in the research industry. Skilled in MATLAB, LabVIEW, Python, R, 8051 Microcontroller, and Deep Learning. Post graduation in Master of Technology - MTech focused in COMMUNICATION SYSTEMS from National Institute of Technology Puducherry.",
    WImg: img1,
    MImg: Main1,
  ...
  },
  {
    ...
    SpeakerImg: AIIMG,
    SpeakerDesc:
      "As an AI Engineer at Litmus7, Karthik K applies their robust problem-solving skills and extensive domain knowledge to intricately design and deploy end-to-end AI solutions across diverse industries, including automotive, agriculture, fashion, healthcare, and real estate. He concentrates on both computer vision and natural language processing, boasting notable expertise in the edge deployment of AI models on mobile and web platforms.",
    WImg: img2,
    MImg: Main2,
